...
<div class="dashboard-container">
  ...
  <section class="projects-section">
      ...
      <ul class="projects-grid">
        {#each projects as project}
          <li class="project-card">
            <a class="project-link" href={`/dashboard/${project.id}`}>{project.projectName}</a>
          </li>
        {/each}
      </ul>
    {:else}
    ...
    <form class="project-form" method="POST">
      <input class="project-input" type="text" name="projectName" placeholder="Project Name" required />
